# This is my package filament-resource-customizer
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/filament-resource-customizer.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/filament-resource-customizer)
...
```bash
php artisan vendor:publish --tag="filament-resource-customizer-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="filament-resource-customizer-views"
```

## Usage

```php
$filamentResourceCustomizer = new Rolland\FilamentResourceCustomizer();
echo $filamentResourceCustomizer->echoPhrase('Hello, Rolland!');
```
...
- [Rolland](https://github.com/rolland)
